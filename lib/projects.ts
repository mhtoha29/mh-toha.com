...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    client: 'Mahabubur Rahman Memorial Hospital — NICU Department',
    category: 'Software / App',
    year: '2025',
    desc: 'Offline-first smart billing and patient management system for Mahabubur Rahman Memorial Hospital (NICU). Handles patient records, daily charges, medicine tracking, and auto-generated bills — faster.',
    tech: ['Python', 'SQLite', 'Offline-first', 'Custom Software', 'Desktop App'],
    liveUrl: '#',
    videoEmbed: 'EItHg9zmN8w',
    featured: true,
    challenge: 'The NICU at Mahabubur Rahman Memorial Hospital tracked billing in paper ledgers, causing errors, delays, and revenue leakage.',
    ...
    result: 'Deployed at Mahabubur Rahman Memorial Hospital NICU. Eliminated manual billing errors. Staff generate accurate bills in under 60 seconds.',
