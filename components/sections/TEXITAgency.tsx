    ...
    <section id="agency" className="section" style={{ background: 'linear-gradient(180deg, #0F172A 0%, #0A1628 100%)' }}>
      ...
      <div className="container" ref={ref}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.7)', maxWidth: '540px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        <div style={{
          ...
          <div className="rg-2" style={{ gap: '48px', alignItems: 'start', position: 'relative', zIndex: 1 }}>
            <div>
              ...
              <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.8, marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                {TEXIT_SERVICES.map((s, i) => (
                  <span key={i} style={{
                    ...
                    background: 'rgba(14,165,233,0.07)', color: 'rgba(255,255,255,0.82)',
            ...
            <div>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.55)' }}>{stat.sub}</div>
                </div>
              ))}
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                {BYV_SERVICES.map((s, i) => (
                  <span key={i} style={{
                    fontSize: '11.5px', fontWeight: 600, letterSpacing: '0.8px', padding: '4px 10px',
                    background: 'rgba(99,102,241,0.08)', color: 'rgba(255,255,255,0.82)',
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.62)' }}>{item.desc}</div>
                  </div>
                </div>
              ))}
